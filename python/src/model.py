...
def systemModel(ECG,time, params = {}, verbose = False, showFigures = False):
  ...
  ECG_dig0, time_dig = AFEmodel.analogFrontEndModel(ECG[0],time, showFigures = showFigures)
  ...
  labels, time_det, features = DBEmodel.digitalBackEndModel(ECG_dig,time_dig, Fs=200, showFigures = showFigures)
