...
SV_params_V = {'kernel':'poly','C':0.1, 'gamma':0.1, 'degree':3, 'FS':None, 'pruning_D': 0, 'class_weight':'balanced','type':'VvX'}
SV_params_S = {'kernel':'poly','C':0.1, 'gamma':0.1, 'degree':3, 'FS':None, 'pruning_D': 0, 'class_weight':'balanced','type':'NvS'}
